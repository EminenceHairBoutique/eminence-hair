      ...
      <section className="relative h-[80vh] min-h-[520px] w-full overflow-hidden">
        ...
        <div className="absolute inset-x-0 bottom-20 px-6 max-w-5xl mx-auto text-[#F9F7F4]">
          ...
          <h1 className="text-3xl md:text-4xl font-light font-display max-w-xl leading-tight">
            Raw, silky Cambodian luxury for women who expect their hair to dress
            like couture.
          </h1>
          <p className="mt-4 text-sm text-neutral-100 max-w-lg">
            Ethically sourced Cambodian &amp; Myanmar hair, crafted in our
            partner atelier. High-density HD lace units engineered for flash,
            studio, and everyday softness.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-[1.3fr,1fr] gap-10 items-center">
          <div className="space-y-4">
            ...
            <p className="text-sm text-neutral-700">
              180–250% density units designed to hold structure, luster, and
              movement under any lighting — from front camera flash to studio
              strobes. HD lace that melts into skin, silkiness that behaves like
              natural hair, never plastic shine.
            </p>

            <div className="grid grid-cols-3 gap-4 mt-4 text-[11px] text-neutral-700">
              <div>
                <p className="uppercase tracking-[0.2em] mb-1 text-neutral-500">
                  Raw Origin
                </p>
                <p>
                  Cambodian &amp; Myanmar donors, low-processed, single-drawn
                  for believable fullness.
                </p>
              </div>
              <div>
                <p className="uppercase tracking-[0.2em] mb-1 text-neutral-500">
                ...
                <p>
                  Transparent, melt-ready lace suitable for editorial installs
                  and daily wear.
                </p>
              </div>
              <div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-sm text-neutral-700">
            <div className="bg-white/80 border border-neutral-200 rounded-2xl p-6 shadow-sm">
              ...
              <p>
                Ethically sourced hair from Cambodia and Myanmar, selected for
                strand strength, uniformity, and natural luster — never coated
                with plastic shine.
              </p>
            </div>
            <div className="bg-white/80 border border-neutral-200 rounded-2xl p-6 shadow-sm">
              ...
              <p>
                Lace grids so fine they disappear with minimal tint. Hairlines
                pre-plucked for a believable melt without over-thinning.
              </p>
            </div>
            <div className="bg-white/80 border border-neutral-200 rounded-2xl p-6 shadow-sm">
              <h3 className="text-xs tracking-[0.24em] uppercase text-neutral-500 mb-3">
              ...
              <p>
                180–250% density mapped across the cap to keep fullness where
                the eye lands — front, crown, and ends — not just packed at the
                nape.
              </p>
            </div>
          </div>
      ...
      <section className="relative w-full h-[80vh] bg-black overflow-hidden border-t border-neutral-900">
        ...
        <div className="absolute inset-x-0 bottom-16 px-6 max-w-5xl mx-auto text-white">
          ...
          <p className="text-sm text-neutral-200 max-w-lg">
            Shot in 4K to capture true luster, density, and flow — not filters.
            Every frame is your hair&apos;s audition under real lighting.
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-4 gap-6 text-sm">
            <div className="bg-white border border-neutral-200 rounded-3xl overflow-hidden shadow-sm flex flex-col">
              ...
              <div className="p-4 flex-1 flex flex-col">
                ...
                <p className="flex-1 text-neutral-700">
                  Pin-straight precision with HD parting and 180–220% density
                  for sleek, tailored looks.
                </p>
                <Link
            ...
            <div className="bg-white border border-neutral-200 rounded-3xl overflow-hidden shadow-sm flex flex-col">
              ...
              <div className="p-4 flex-1 flex flex-col">
                ...
                <p className="flex-1 text-neutral-700">
                  Off-duty glamour waves with 200–250% density for soft, expensive
                  movement.
                </p>
                <Link
            ...
            <div className="bg-white border border-neutral-200 rounded-3xl overflow-hidden shadow-sm flex flex-col">
              ...
              <div className="p-4 flex-1 flex flex-col">
                ...
                <p className="flex-1 text-neutral-700">
                  Defined, brushable textures that keep their pattern after washing
            ...
            <div className="bg-white border border-neutral-200 rounded-3xl overflow-hidden shadow-sm flex flex-col">
              ...
              <div className="p-4 flex-1 flex flex-col">
                ...
                <p className="flex-1 text-neutral-700">
                  Champagne-toned 613 pieces built to avoid brassiness and keep
                  their integrity under toners.
                </p>
                <Link
        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-[1.4fr,1.2fr] gap-10 items-center">
          <div>
            ...
            <p className="text-sm text-neutral-700 mb-5">
              A curated capsule of silhouettes for this season: sharp middle
              parts, off-duty blowouts, and deep waves that photograph like
              campaign hair.
            </p>
            <Link
              to="/collections"
        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-[1.4fr,1.3fr] gap-10 items-center">
          ...
          <div>
            ...
            <p className="text-sm text-neutral-700 mb-4">
              Your pieces are produced in our vetted partner factory, with
              documentation for origin, processing level, and density. We go
              beyond typical “raw hair” claims — Eminence units are built to
              live on camera and in real life.
            </p>
            <Link
              to="/authenticity"
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-sm text-neutral-100">
            <div>
              ...
              <p>
                180–250% density that matches the label, not just staged
                photos. What you see is what you unbox.
              </p>
            </div>
            <div>
              <h3 className="text-xs tracking-[0.24em] uppercase text-neutral-400 mb-2">
              ...
              <p>
                Units tested under flash, daylight, and low light so your hair
                performs in real life, not just studio renders.
              </p>
            </div>
            <div>
              <h3 className="text-xs tracking-[0.24em] uppercase text-neutral-400 mb-2">
              ...
              <p>
                Built to be washed, styled, and reworn — not disposable hair for
                a single event.
              </p>
            </div>
          </div>
      ...
      <section className="py-16 border-t border-neutral-200 bg-[#F9F7F4]">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-sm text-neutral-700 mb-6">
            Early access to capsules, priority restocks, and ritual-based care
            guides. Your 10% welcome code will meet you at checkout.
          </p>
