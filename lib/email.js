    ...
    html: `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #FAF8F5; color: #1B1B1B;">
        ...
        <div style="display: none; max-height: 0; overflow: hidden; font-size: 1px; color: #FAF8F5;">
          Your order ${orderNumber} is confirmed &mdash; thank you for choosing Eminence.
        </div>
        ...
        <div style="padding: 32px 24px;">
          ...
          <p style="margin: 0 0 10px; font-size: 14px; color: #555; line-height: 1.5;">
            ...
            You&rsquo;ll receive another email once your order ships.
          </p>
        ...
        <div style="background-color: #1B1B1B; padding: 20px 24px; text-align: center;">
          ...
          <p style="margin: 0; font-size: 11px; color: #777;">
            Discreet luxury packaging &middot; Premium quality guaranteed
          </p>
...
export async function sendAbandonedCartEmail({ to, sessionUrl }) {
  return requireResend().emails.send({
    from: "Eminence Hair <orders@eminenceluxuryhair.com>",
    to,
    reply_to: "support@eminenceluxuryhair.com",
    ...
    html: `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #FAF8F5; color: #1B1B1B;">
        <div style="display: none; max-height: 0; overflow: hidden; font-size: 1px; color: #FAF8F5;">
          Your Eminence selection is still waiting — complete your order before it's gone.
        </div>
        <div style="background-color: #1B1B1B; padding: 28px 24px; text-align: center;">
          <p style="margin: 0; font-size: 14px; letter-spacing: 0.28em; text-transform: uppercase; color: #D4AF37;">
            Eminence Hair Boutique
        ...
        <div style="padding: 32px 24px;">
          ...
          <p style="margin: 0 0 20px; font-size: 14px; color: #555; line-height: 1.6;">
            You were so close to making it yours. The pieces in your cart are still available
            — but with limited inventory, we can&rsquo;t hold them forever.
          </p>
          <div style="text-align: center; margin: 28px 0;">
            <a href="${sessionUrl || 'https://www.eminenceluxuryhair.com/shop'}"
               style="display: inline-block; padding: 14px 32px; background-color: #1B1B1B; color: #FAF8F5; font-size: 12px; letter-spacing: 0.18em; text-transform: uppercase; text-decoration: none; border-radius: 999px;">
              Complete Your Order
            </a>
          </div>
          <p style="margin: 20px 0 0; font-size: 13px; color: #777; line-height: 1.5;">
            Need help deciding? Our concierge team is here for you &mdash;
            <a href="https://www.eminenceluxuryhair.com/private-consult" style="color: #1B1B1B; text-decoration: underline;">book a private consult</a>.
          </p>
        </div>
        <div style="background-color: #1B1B1B; padding: 20px 24px; text-align: center;">
          <p style="margin: 0 0 4px; font-size: 11px; color: #D4AF37; letter-spacing: 0.18em; text-transform: uppercase;">
...
export async function sendCareGuideEmail({ to, orderNumber }) {
  return requireResend().emails.send({
    from: "Eminence Hair <care@eminenceluxuryhair.com>",
    to,
    reply_to: "support@eminenceluxuryhair.com",
    subject: `Your Eminence care ritual — Order ${orderNumber}`,
    html: `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #FAF8F5; color: #1B1B1B;">
        <div style="display: none; max-height: 0; overflow: hidden; font-size: 1px; color: #FAF8F5;">
          Three essential care tips to keep your Eminence hair performing beautifully.
        </div>
        <div style="background-color: #1B1B1B; padding: 28px 24px; text-align: center;">
          <p style="margin: 0; font-size: 14px; letter-spacing: 0.28em; text-transform: uppercase; color: #D4AF37;">
            Eminence Hair Boutique
        ...
        <div style="padding: 32px 24px;">
          ...
          <p style="margin: 0 0 24px; font-size: 14px; color: #555; line-height: 1.6;">
            Beautiful hair starts with the right routine. Here are three essentials
            to keep your Eminence pieces at their best.
          </p>

          <div style="margin-bottom: 20px; padding: 16px; background: #fff; border: 1px solid #EAE8E3; border-radius: 8px;">
            <p style="margin: 0 0 4px; font-size: 12px; letter-spacing: 0.18em; text-transform: uppercase; color: #D4AF37;">Washing</p>
            <p style="margin: 0; font-size: 13px; color: #555; line-height: 1.5;">
              Use sulfate-free shampoo and lukewarm water. Gently detangle with a wide-tooth
              comb before washing. Always wash in a downward motion to preserve cuticle alignment.
            </p>
          </div>

          <div style="margin-bottom: 20px; padding: 16px; background: #fff; border: 1px solid #EAE8E3; border-radius: 8px;">
            <p style="margin: 0 0 4px; font-size: 12px; letter-spacing: 0.18em; text-transform: uppercase; color: #D4AF37;">Styling</p>
            <p style="margin: 0; font-size: 13px; color: #555; line-height: 1.5;">
              Heat tools up to 180°C / 356°F are safe. Always use a heat protectant.
              Air drying is recommended to preserve natural texture and extend longevity.
            </p>
          </div>

          <div style="margin-bottom: 20px; padding: 16px; background: #fff; border: 1px solid #EAE8E3; border-radius: 8px;">
            <p style="margin: 0 0 4px; font-size: 12px; letter-spacing: 0.18em; text-transform: uppercase; color: #D4AF37;">Storage</p>
            <p style="margin: 0; font-size: 13px; color: #555; line-height: 1.5;">
              Store on a silk or satin surface. When not in use, keep your unit on a wig stand
              to maintain shape. Avoid direct sunlight for extended periods.
            </p>
          </div>

          <div style="text-align: center; margin: 28px 0;">
            <a href="https://www.eminenceluxuryhair.com/care"
               style="display: inline-block; padding: 14px 32px; background-color: #1B1B1B; color: #FAF8F5; font-size: 12px; letter-spacing: 0.18em; text-transform: uppercase; text-decoration: none; border-radius: 999px;">
              Full Care Guide
            </a>
          </div>
...
export async function sendReviewRequestEmail({ to, orderNumber }) {
  return requireResend().emails.send({
    from: "Eminence Hair <care@eminenceluxuryhair.com>",
    to,
    reply_to: "support@eminenceluxuryhair.com",
    subject: `How's your hair? — Order ${orderNumber}`,
    html: `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #FAF8F5; color: #1B1B1B;">
        <div style="display: none; max-height: 0; overflow: hidden; font-size: 1px; color: #FAF8F5;">
          We'd love to hear about your experience with your Eminence order.
        </div>
        <div style="background-color: #1B1B1B; padding: 28px 24px; text-align: center;">
          <p style="margin: 0; font-size: 14px; letter-spacing: 0.28em; text-transform: uppercase; color: #D4AF37;">
            Eminence Hair Boutique
        ...
        <div style="padding: 32px 24px;">
          <h2 style="margin: 0 0 8px; font-size: 22px; font-weight: 500; color: #1B1B1B;">
            How&rsquo;s your hair?
          </h2>
          <p style="margin: 0 0 20px; font-size: 14px; color: #555; line-height: 1.6;">
            It&rsquo;s been two weeks since your order ${orderNumber} arrived.
            We&rsquo;d love to hear how your Eminence pieces are performing &mdash;
            your feedback helps us (and future clients) choose with confidence.
          </p>
          <div style="text-align: center; margin: 28px 0;">
            <a href="https://www.eminenceluxuryhair.com/contact"
               style="display: inline-block; padding: 14px 32px; background-color: #1B1B1B; color: #FAF8F5; font-size: 12px; letter-spacing: 0.18em; text-transform: uppercase; text-decoration: none; border-radius: 999px;">
